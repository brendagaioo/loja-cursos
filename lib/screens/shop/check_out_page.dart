...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('assets/products/nodejs.png',
        '                            Curso - JS', 'description', 45.3),
    Product('assets/products/js.png',
        '                            Curso - Python', 'description', 22.3),
    Product('assets/products/python.png',
        '                            Curso - NodeJS', 'description', 58.3)
  ];
